...
migrate((app) => {
  const collection = new Collection({
    ...
    "id": "pbc_829252413",
    "indexes": [
      "CREATE UNIQUE INDEX idx_staff_school_id ON staff (school_id)",
    ...
    "listRule": "@request.auth.collectionName = 'admins' || id = @request.auth.id",
    "manageRule": null,
    "mfa": {
      "duration": 600,
      "enabled": false,
    ...
    "viewRule": "@request.auth.collectionName = 'admins' || id = @request.auth.id"
  });
